...
if (!(Test-Path -Path $PROFILE -PathType Leaf)) {
    try {
        ...
        Invoke-RestMethod https://github.com/itzkavishka/Power-Shell/blob/171c682a06c8d8e56f356e161ae6b789a2fb7254/Microsoft.PowerShell_profile.ps1 -OutFile $PROFILE
    ...
    try {
        ...
        Invoke-RestMethod https://raw.githubusercontent.com/itzkavishka/Power-Shell/171c682a06c8d8e56f356e161ae6b789a2fb7254/Microsoft.PowerShell_profile.ps1 -OutFile $PROFILE
